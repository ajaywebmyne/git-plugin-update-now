...
function github_plugin_updater_test_init() {
	...
	if ( is_admin() ) { // note the use of is_admin() to double check that this is happening in the admin
		...
		$config = array(
			...
			'api_url' => 'https://api.github.com/repos/ajaywebmyne/git-plugin-update-now',
			'raw_url' => 'https://raw.github.com/ajaywebmyne/git-plugin-update-now/master',
			'github_url' => 'https://github.com/ajaywebmyne/git-plugin-update-now',
			'zip_url' => 'https://github.com/ajaywebmyne/git-plugin-update-now/archive/master.zip',
			'sslverify' => false,
			'requires' => '3.8.1',
			'tested' => '5.3.2',
			'readme' => 'README.md',
			'access_token' => 'd8ffa7b13b58fdcf4e999b9e6ee9aef31bec8d50',
		);
